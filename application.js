...
var _storesPost_store = require("./stores/post_store");

var _storesPost_store2 = _interopRequireDefault(_storesPost_store);
...
var App = (function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      return React.createElement(_componentsLayout2["default"], {
...
React.render(React.createElement(App, null), document.documentElement);
...
var PostStore = (function () {
  ...
  _createClass(PostStore, [{
    key: "all",
    value: function all() {
      var request = new _utilsRequest2["default"]("./index.json");
